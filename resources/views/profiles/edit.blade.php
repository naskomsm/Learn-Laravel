...
@section('content')
<div class="container">
    <form action="/profile/someID123" enctype="multipart/form-data" method="post">
        @csrf
        @method('PATCH')
        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="form-group row">
                    ...
                    <input id="title" name="title" type="text" class="form-control @error('title') is-invalid @enderror" value="{{
                        old('title') ?? $user->profile->title }}" required autocomplete="title" autofocus>
